...
# button4 = tk.Button(root, text=" Music Play List ", bd=5,command=prediction_emotionm,width=19, height=1, font=('times', 15, ' bold '),bg="black",fg="white")
