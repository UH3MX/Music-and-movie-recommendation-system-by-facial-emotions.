...
canvas.pack()
text_var="FACIAL EMOTION BASED MUSIC/MOVIE RECOMMENDATION SYSTEM"
...
d2=tk.Button(root,text="Music Recommendation",command=Music,width=20,height=1,bd=5,background="#6C7B8B",foreground="white",font=("times new roman",14,"bold"))
d2.place(x=550,y=200)


d3=tk.Button(root,text="Movie Recommendation",command=Movie,width=20,height=1,bd=5,background="#6C7B8B",foreground="white",font=("times new roman",14,"bold"))
d3.place(x=550,y=300)
